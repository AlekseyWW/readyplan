...
__webpack_require__(/*! ./form */ "./resources/js/form.js"); // if you're using a bundler, first import:


var Headroom = __webpack_require__(/*! headroom.js */ "./node_modules/headroom.js/dist/headroom.js");

var header = document.querySelector('header');
var headroom = new Headroom(header); // initialise
...
var contents = document.querySelectorAll('.top-slider__content');
...
navs.forEach(function (nav) {
  var linkTo = nav.dataset.target;
  var block = document.querySelector(linkTo);
  console.log({
    block: block
  });
...
var forms = document.querySelectorAll('.web-form');
...
var successToast = new bootstrap.Toast(toastElSuccess);
toast.success = _objectSpread(_objectSpread({}, successToast), {}, {
  show: function show(text) {
    toastElSuccess.querySelector('.toast-body').textContent = text;
    successToast.show();
  }
});
var errorToast = new bootstrap.Toast(toastElError);
toast.error = _objectSpread(_objectSpread({}, errorToast), {}, {
  show: function show(text) {
...
function handleFormSubmit(event) {
  ...
  var _event$target = event.target,
      action = _event$target.action,
      method = _event$target.method;
  ...
  fetch(action, {
    ...
    return onFormSuccess(data, event.target);
  })["catch"](function (data) {
    return onFormError(data, event.target);
  });
}
...
__webpack_require__(/*! /Users/aleksejvaznikov/dev/websites/laravels/ready-plan.ru/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/aleksejvaznikov/dev/websites/laravels/ready-plan.ru/resources/css/app.css */"./resources/css/app.css");
